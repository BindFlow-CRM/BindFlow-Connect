    ...
    <div className="dark min-h-screen bg-[#0D1117] flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <div className="mb-4">
            {/* 
              CAMBIO CLAVE: Se usa <a> en lugar de <Link> para forzar la salida 
              del subpath /app y cargar la landing.html de la raíz 
            */}
            <a
              href="/"
          ...
          <img
            src={logoUrl}
            alt="BindFlow"
            className="h-24 w-64 object-contain mx-auto mb-4"
          />
          <h1 className="text-2xl font-bold text-[#E6EDF3]">Welcome back</h1>
          <p className="text-[#8B949E] text-sm mt-1">
            Sign in to your BindFlow account
          </p>
        </div>
            ...
            <div>
              <div className="flex justify-between items-center mb-1.5">
                ...
                <Link
                  ...
                  size="xs"
                  className="text-xs text-[#00B4D8] hover:text-[#00E5A0] transition-colors"
                >
                  Forgot password?
                </Link>
              </div>
